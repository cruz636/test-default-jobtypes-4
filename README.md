...
## Project Structure
    ...
    ├── test_default_jobtypes_4  # Django project configurations
...
1. Clone this repo and `cd test_default_jobtypes_4`
...
2. Clone this repo and `cd test_default_jobtypes_4`
